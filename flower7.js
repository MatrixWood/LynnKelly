...
KISSY.add(function (S, Node, Event, Audio) {
    ...
    S.augment(Flower7, {
        ...
        initShare: function() {
            ...
            var title = encodeURIComponent('#锴琳生日快乐#祝锴琳生日快乐@LynnKelly');
            var source = encodeURIComponent('锴琳生日快乐！'); // 网站名称
            var windowName = 'share'; //
            var site = 'http://canftin.com/';
        ...
        initAudio: function() {
           ...
           var Melody = {
               back: './music/fightforeveryone.mp3'
           };
